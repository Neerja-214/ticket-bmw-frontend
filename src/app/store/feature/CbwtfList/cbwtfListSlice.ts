...
const initialState: cbwtfListState = {
  tableData: [],
  frmData: "",
  gid : "",
  prntRep : "",
...
// export const fetchSomeData = createAsyncThunk('cbwtfList/fetchSomeData', async () => {
//     try {
...
export const cbwtfListSlice = createSlice({
  name: 'cbwtfList',
  initialState,
  reducers: {
...
export const { storeTableData, storeFormData, appendTableData,storeGidData,storePrintData,clearStateAll } = cbwtfListSlice.actions

export const selectTableData = (state: RootState) => state.cbwtfList.tableData
export const selectFormData = (state: RootState) => state.cbwtfList.frmData
export const selectGidData= (state: RootState) => state.cbwtfList.gid
export const selectPrintReport= (state: RootState) => state.cbwtfList.prntRep

export default cbwtfListSlice.reducer