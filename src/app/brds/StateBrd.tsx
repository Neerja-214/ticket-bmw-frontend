...
const SttDirctrLst = () => {
  ...
  const GetDataCity = () => {
    ...
    let wh = who;
    let lvl = getLvl() || ""
    let payload: any = postLinux(lvl + '=' + wh.toUpperCase() + "=" + fltr, 'getcity');
  ...
  useEffectOnce(() => {
    if (isEdit) {
      let data = JSON.parse(sessionStorage.getItem("sttDetails") || '');
      if (data) {
          ...
          <div className="grid grid-cols-3 ms-5">
            ...
            <div className="mb-3">
              <WtrInput
                ...
                placement="bottom"
                ToolTip="Enter name of nodal officer without special characters "
              ></WtrInput>
            </div>
            <div className="mb-3">
              <WtrInput
