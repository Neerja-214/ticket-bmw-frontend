...
const DashboardChartView3050Abv = (props: any) => {
                    ...
                    <div className=' bg-gray-100 m-0 p-0'>
                        ...
                        {/* <div className="mt-3 grid grid-cols-1 sm:grid-cols-1 md:grid-cols-3 lg:grid-cols-3 xl:grid-cols-3 gap-4   ">
                            <div className=" bg-white py-2 px-3  rounded shadow">
                                ...
                                <div className=" m-2 ">
                                    {toggleState ? (<>
                                        <DashboardChart chrtType="PieChart" chrtHeight={300} chrtData={chrtDataGenWt} chrtOptions={options3}></DashboardChart>
                                    </>) : <>
                                        <DashboardChart chrtType="PieChart" chrtHeight={300} chrtData={chrtDataGenCnt} chrtOptions={options3}></DashboardChart>
                                    </>}
                                </div>
                            </div>
                            <div className=" bg-white py-2 px-3  rounded shadow">
                                ...
                                <div className="m-2 ">
                                    {toggleState ? (<>
                                        <DashboardChart chrtType="PieChart" chrtHeight={300} chrtData={chrtDataGenWt} chrtOptions={options4}></DashboardChart>

                                    </>) : <>
                                        <DashboardChart chrtType="PieChart" chrtHeight={300} chrtData={chrtDataGenCnt} chrtOptions={options4}></DashboardChart>
                            ...
                            <div className=" bg-white py-2 px-3  rounded shadow">
                                ...
                                <div className="mx-2 flex justify-center items-center h-full">
                                    {toggleState ? (<>
                                        <GraphDataTable data={dataBelowAboveCnt30} heading={headingBelow50}/>

                                    </>) : <>
                                        <GraphDataTable data={dataBelowAboveWt30}  heading={headingBelow50}/>
...
}; export default React.memo(DashboardChartView3050Abv);