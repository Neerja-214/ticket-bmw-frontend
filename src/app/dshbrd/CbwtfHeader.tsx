                ...
                <div className="mx-4 flex items-center relative " onMouseEnter={toggleDropdown} onMouseLeave={toggleDropdown} onClick={toggleDropdown}>
                  ...
                  {isDropdownOpen && <div className="absolute top-[20px]" style={{ width: '200px' }}>
                    <div className="text-black mt-2 bg-slate-100 rounded-lg pt-2  border">
                      <ul>
                        <li className="py-1 px-4 border-b hover:text-lg w-full"><a href='/cbwtfDtl'>CBWTF Details</a></li>
                       <li className="py-1 px-4 border-b hover:text-lg w-full"><a href='/cbwtfAnnulRpt'>CBWTF Annual Report Form</a></li>
                       {/* <li className="py-1 px-4 border-b hover:text-lg w-full"><a href='/cbwtfMonthlyRpt'>CBWTF Monthly Report Form</a></li> */}
...
export default React.memo(CbwtfHeader);