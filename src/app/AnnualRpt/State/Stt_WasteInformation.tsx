...
const Stt_WasteInformation = () => {
  ...
  const reqFlds = [
    ...
    { fld: 'cptvwst', msg: 'Total BMW treated by captive treatment facilities by HCF in Kg/day', chck: '1[length]' },
    { fld: 'ttlvio', msg: 'Total no. of violation by HCFs & CBWTFs', chck: '1[length]' },
    { fld: 'ttlshwcause', msg: 'Total No. of show cause notices/Directions issued to defaulter HCFs/CBWTFs', chck: '1[length]' },
    { fld: 'ttlcoem', msg: 'No. of CBWTFs that have installed COEMS', chck: '1[length]' },
  ];

  const coldef = [
    { field: 'id', hide: true, width: 0, headerName: '' },
    { field: 'dt_mnth', headerName:'Select Month', hide:false, width: 250},
    { field: 'cptvwst', headerName:'Total BMW treated by captive treatment facilities by HCF in Kg/day', hide:false, width: 250},
    { field: 'ttlvio', headerName:'Total no. of violation by HCFs & CBWTFs', hide:false, width: 250},
    { field: 'ttlshwcause', headerName:'Total No. of show cause notices/Directions issued to defaulter HCFs/CBWTFs', hide:false, width: 250},
    { field: 'ttlcoem', headerName:'No. of CBWTFs that have installed COEMS', hide:false, width: 250},
  ...
  const GetSvData = (month:string) => {
    ...
    if(month){
        let payload:any = postLinux('STT=' + who + "=" + month + "=stt_wasteInformation", 'getWasteInformation')
        return nrjAxiosRequestBio("stt_wasteInformation", payload);
    }
    else{
        clrFunct();
        let payload:any = postLinux('STT=' + who + "=stt_listWasteInformation", 'listWasteInformation')
        return nrjAxiosRequestBio("stt_listWasteInformation", payload);
    }
  };
    ...
    <div className="bg-white pt-2 pb-12">
      ...
      <div className="shadow rounded-lg">
        <div>
          ...
          <div className="mb-1">
              <WtrInput
                Label='Total BMW treated by captive treatment facilities by HCF in Kg/day'
                fldName='cptvwst'
                idText='txtcptvwst'
                onChange={onChangeDts}
                dsabld={false}
                ...
                speaker={'Total BMW treated by captive treatment facilities by HCF in Kg/day'}
                delayClose={1000}
                placement='right'
            ...
            <div className="mb-1">
              <WtrInput
                Label="Total no. of violation by HCFs & CBWTFs"
                fldName='ttlvio'
                idText='txtttlvio'
                onChange={onChangeDts}
                dsabld={false}
                ...
                selectedValue={state.frmData}
                clrFnct={state.trigger}
                speaker={'Total no. of violation by HCFs & CBWTFs'}
                delayClose={1000}
                placement='bottom'
                ClssName=''
                ToolTip="Enter whole numbers only"
            ...
            <div className="mb-1">
              <WtrInput
                Label="Total No. of show cause notices/Directions issued to defaulter HCFs/CBWTFs"
                speaker="Total No. of show cause notices/Directions issued to defaulter HCFs/CBWTFs"
                fldName='ttlshwcause'
                idText='txtttlwth'
                onChange={onChangeDts}
                dsabld={false}
            ...
            <div className="mb-1">
              <WtrInput
                Label="No. of CBWTFs that have installed COEMS"
                speaker="No. of CBWTFs that have installed COEMS"
                fldName='ttlcoem'
                idText='txtttlcoem'
                onChange={onChangeDts}
                dsabld={false}
...
}; export default React.memo(Stt_WasteInformation);
