...
import utilities, { GetResponseWnds, createGetApi, gridAddToolTipColumn, postLinux, GetResponseLnx, getCmpId, getUsrnm, trimField } from "../../utilities/utilities";
...
const HcfRegisterIndpnt = (props: any) => {
    ...
    const GetHCFConsentList = () => {
        ...
        const payload: any = postLinux(lvl + '=' + who + '=' + grdCnt + '=' + usrnm + '=' + cmpid, 'hcf_register_ind');
        return nrjAxiosRequestBio("hcf_reg_direct", payload);
    };
            ...
            <div className="bg-white p-1 pr-2 my-3 pb-2 rounded-lg" style={{ boxShadow: '0px 2px 4px 0px rgba(0, 0, 0, 0.12)' }}>
                ...
                <div className="">
                    <div className="grid grid-cols-3 ml-1 flex items-end">
                        ...
                        <div className="bg-white px-4 mb-1">
                            ...
                            {!hideInStt && <div className="mt-2 flex px-2 items-center">
...
export default React.memo(HcfRegisterIndpnt);
