...
const HcfConsentReport = (props: any) => {
    ...
    const coldef: any[] = [
        ...
        },
        {
            field: "dt_exp",
            width: 180,
            headerName: "Consent Expire Date",
        },
    ];
    ...
    const GetHCFConsentList = () => {
        ...
        const payload: any = postLinux(lvl + '=' + who + '=' + grdCnt + '=' + usrnm + '=' + cmpid , 'hcf_consent_exprd');
        return nrjAxiosRequestBio("hcf_consent_exprd", payload);
    };
...
export default React.memo(HcfConsentReport);
