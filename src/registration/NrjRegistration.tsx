  ...
  <div className="bg-gray-200 bg-opacity-20 backdrop-blur-sm p-8 rounded-2xl shadow-lg w-full max-w-2xl mx-4 my-8">
    ...
    <form className="space-y-6" onSubmit={handleSubmit}>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-white mb-2">Select your role</label>
          <select
            name="role"
            value={formData.role}
            onChange={handleChange}
        ...
        <div>
          <label className="block text-sm font-medium text-white mb-2">Registration Number (Optional)</label>
          <input
            type="text"
            name="eprNumber"
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div>
          <label className="block text-sm font-medium text-white mb-2">Registered Email Id</label>
          <input
            type="email"
            name="email"
        ...
        <div>
          <label className="block text-sm font-medium text-white mb-2">Registered Contact Number</label>
          <div className="flex">
            <span className="mt-1 p-3 border rounded-l-lg bg-gray-700 text-white flex items-center">+91</span>
            <input
              type="tel"
              name="contactNumber"
              value={formData.contactNumber}
              onChange={handleChange}
              className="mt-1 p-3 w-full border rounded-r-lg bg-white bg-opacity-10 text-white placeholder-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-300"
      ...
      <Button
        ...
        fullWidth
        variant="contained"
        className="w-full py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 text-lg font-medium mt-6"
      >
        Register
      </Button>
    </form>
